  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto">
          <div className="flex items-center justify-between px-4">
            <div className="flex items-center">
              <img src="/logo/rpm-auto-logo.svg" alt="RPM Auto" className="h-10 w-auto" />
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-10 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center">
          <img src="/logo/rpm-auto-logo.svg" alt="RPM Auto" className="h-8 w-auto" />
          ...
          <SheetContent side="left" className="p-0 w-72">
            <SheetHeader className="px-4 py-3 border-b">
              <SheetTitle className="text-left flex items-center">
                <img src="/logo/rpm-auto-logo.svg" alt="RPM Auto" className="h-8 w-auto mr-2" />
                Employee Portal
              </SheetTitle>
            </SheetHeader>
