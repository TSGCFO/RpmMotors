    ...
    <main className="bg-[#F5F5F5] min-h-screen">
      ...
      <JsonLdSchema
        schema={createBreadcrumbSchema([
          ...
          { name: "Inventory", item: "https://www.rpmautosales.ca/inventory" },
          { name: `${vehicle.year} ${vehicle.make} ${vehicle.model}`, item: `https://www.rpmautosales.ca/inventory/${vehicle.id}` }
        ])}
      />
