...
export const pageMetadata: Record<string, PageMetadata> = {
  home: {
    title: "RPM Auto: Luxury & Exotic Cars Dealer | Richmond Hill ON | 50+ Premium Vehicles",
    description: "Discover 50+ luxury vehicles at RPM Auto Richmond Hill. Ferrari, Lamborghini, Porsche & more. Expert financing, trade-ins welcome. Call (647) 550-9590 for exclusive deals!",
    keywords: "luxury cars dealer Richmond Hill, exotic cars Toronto, premium vehicles, Ferrari dealer, Lamborghini, Porsche, BMW M, Mercedes AMG, car financing, trade-in"
  },
  inventory: {
    title: "Luxury Car Inventory | 50+ Premium Vehicles | RPM Auto Richmond Hill",
    ...
    keywords: "luxury car inventory, exotic cars for sale, premium vehicles Richmond Hill, certified pre-owned, sports cars, SUVs, test drive"
  },
  services: {
    ...
    keywords: "car financing Richmond Hill, trade-in value, extended warranty, vehicle sourcing, consignment, luxury car services"
  },
  about: {
    title: "About RPM Auto | 10+ Years of Excellence | Luxury Car Experts",
    description: "Family-owned luxury dealership since 2013. 500+ satisfied customers, A+ BBB rating. Meet our certified team. Visit our Richmond Hill showroom by appointment.",
    keywords: "about RPM Auto, luxury car dealership, Richmond Hill auto dealer, family owned, certified team, customer testimonials"
  },
  contact: {
    title: "Contact RPM Auto Richmond Hill | Directions, Hours | (647) 550-9590",
    description: "Visit RPM Auto in Richmond Hill. Open Mon-Sat, Sunday by appointment. Quick responses guaranteed. Get directions, book appointments, or call (647) 550-9590.",
    keywords: "contact RPM Auto, dealership hours, directions Richmond Hill, book appointment, phone number, email, location"
  },
  gallery: {
